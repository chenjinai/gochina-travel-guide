...
const en: Content = {
  ...
  intro:
    "Depending on your nationality and itinerary, you may qualify for visa-free entry, a 144-hour transit exemption, or need a regular tourist (L) visa. This guide covers all three paths.",
  types: {
    ...
    rows: [
      ...
      { code: "G", name: "Transit Visa", stay: "72–144 hours", who: "Transit passengers" },
  ...
  visaFree: {
    ...
    unilateralDesc:
      "Since 1 Dec 2024, China has rolled out unilateral visa-free entry for many European countries, expanded in 2025 to include Australia, New Zealand, Poland and more. Each stay up to 15 days for tourism, business or family visits.",
    unilateralCountries: [
      "France 🇫🇷", "Germany 🇩🇪", "Italy 🇮🇹", "Netherlands 🇳🇱", "Spain 🇪🇸",
      "Switzerland 🇨🇭", "Ireland 🇮🇪", "Hungary 🇭🇺", "Austria 🇦🇹", "Belgium 🇧🇪",
      "Luxembourg 🇱🇺", "New Zealand 🇳🇿", "Australia 🇦🇺", "Poland 🇵🇱", "Malaysia 🇲🇾",
    ],
    unilateralWarn:
      "Only for tourism, business or family visits — NOT for work, study or journalism. Max 15 days per entry (as stamped at the border).",
    mutualTitle: "Mutual visa-exemption agreements",
    mutualRows: [
      { country: "Singapore 🇸🇬", stay: "30 days", note: "Up to 90 days per calendar year" },
      { country: "Thailand 🇹🇭", stay: "30 days", note: "Effective Mar 2024" },
      { country: "Georgia 🇬🇪", stay: "30 days" },
      { country: "Azerbaijan 🇦🇿", stay: "30 days" },
      { country: "Kazakhstan 🇰🇿", stay: "14 days", note: "Added 2024" },
      ...
      { country: "UAE 🇦🇪", stay: "30 days", note: "Since Jan 2018" },
  ...
  transit: {
    title: "144-hour Transit Visa Exemption",
    what:
      "Even if you don't qualify for visa-free entry, you may still enter China for up to 144 hours (6 days) if you are transiting to a third country. A great way to squeeze a short trip in around a layover!",
    ...
    conditions: [
      ...
      "Be a citizen of one of the 53 eligible countries.",
      "Enter through one of the designated ports.",
      "Stay no more than 144 hours (6 days).",
      "Remain inside the permitted province/city zone.",
    ],
    countriesTitle: "Eligible countries (53 total)",
    countries:
      "All Schengen states · UK · Ireland · USA · Canada · Brazil · Mexico · Argentina · Chile · Australia · New Zealand · South Korea · Japan · Singapore · Brunei · UAE · Qatar · Bahrain · Kuwait · Saudi Arabia · Oman · Serbia · Croatia · Bosnia · Montenegro · North Macedonia · Albania · Iran · Tunisia · Kazakhstan · Russia.",
...
const zh: Content = {
  ...
  intro:
    "根据你的国籍和行程，你可能可以免签入境、申请 144 小时过境免签，或需要办理正式的旅游 (L) 签证。本指南涵盖三种情况。",
  types: {
    title: "中国签证类型一览",
    ...
    rows: [
      ...
      { code: "G 字", name: "Transit Visa", stay: "72–144 小时", who: "过境旅客" },
  ...
  visaFree: {
    ...
    unilateralDesc:
      "自 2024 年 12 月 1 日起，中国对法国、德国、意大利、荷兰、西班牙、瑞士、爱尔兰、匈牙利、奥地利、比利时、卢森堡、马来西亚等 12 国试行免签政策。2025 年进一步扩大至新西兰、澳大利亚、波兰等。每次停留不超过 15 天，仅限旅游、商务或探亲。",
    unilateralCountries: [
      "法国 🇫🇷", "德国 🇩🇪", "意大利 🇮🇹", "荷兰 🇳🇱", "西班牙 🇪🇸",
      "瑞士 🇨🇭", "爱尔兰 🇮🇪", "匈牙利 🇭🇺", "奥地利 🇦🇹", "比利时 🇧🇪",
      "卢森堡 🇱🇺", "新西兰 🇳🇿", "澳大利亚 🇦🇺", "波兰 🇵🇱", "马来西亚 🇲🇾",
    ],
    unilateralWarn:
      "免签仅适用于旅游、商务或探亲，不适用于工作、学习或新闻报道。每次入境最长 15 天（以海关标注为准）。",
    mutualTitle: "互免签证协议国家",
    mutualRows: [
      { country: "新加坡 🇸🇬", stay: "30 天", note: "每自然年累计不超过 90 天" },
      { country: "泰国 🇹🇭", stay: "30 天", note: "2024 年 3 月起生效" },
      { country: "格鲁吉亚 🇬🇪", stay: "30 天" },
      { country: "阿塞拜疆 🇦🇿", stay: "30 天" },
      { country: "哈萨克斯坦 🇰🇿", stay: "14 天", note: "2024 年新增" },
      { country: "塞尔维亚 🇷🇸", stay: "30 天" },
      { country: "波黑 🇧🇦", stay: "90 天", note: "每 180 天累计" },
      { country: "白俄罗斯 🇧🇾", stay: "30 天" },
      { country: "阿尔巴尼亚 🇦🇱", stay: "90 天", note: "每 180 天累计" },
      { country: "阿联酋 🇦🇪", stay: "30 天", note: "2018 年 1 月起" },
  ...
  transit: {
    title: "144 小时过境免签",
    what:
      "即使你不符合免签条件，只要是经中国过境前往第三国，仍可在指定省市免签停留最多 144 小时（6 天），可以利用转机时间游览中国。",
    ...
    countriesTitle: "适用国家（共 53 个）",
    countries:
      "申根国家 · 英国 · 爱尔兰 · 美国 · 加拿大 · 巴西 · 墨西哥 · 阿根廷 · 智利 · 澳大利亚 · 新西兰 · 韩国 · 日本 · 新加坡 · 文莱 · 阿联酋 · 卡塔尔 · 巴林 · 科威特 · 沙特阿拉伯 · 阿曼 · 塞尔维亚 · 克罗地亚 · 波黑 · 黑山 · 北马其顿 · 阿尔巴尼亚 · 伊朗 · 突尼斯 · 哈萨克斯坦 · 俄罗斯。",
