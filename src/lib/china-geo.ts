...
export const ALL_CITIES = [
  ...
  "wuxi", "yangzhou", "yancheng", "shaoxing", "xuzhou",
  "quanzhou", "xiamen",
...
export const CITY_LABELS_ZH: Record<CityKey, string> = {
  ...
  wuxi: "无锡", yangzhou: "扬州", yancheng: "盐城",
  shaoxing: "绍兴", xuzhou: "徐州",
  quanzhou: "泉州", xiamen: "厦门",
...
export const CITY_COORDS: Record<CityKey, CityCoord> = {
  ...
  yangzhou: { lat: 32.3942, lng: 119.4129 },
  yancheng: { lat: 33.3495, lng: 120.1616 },
  shaoxing: { lat: 29.9958, lng: 120.5861 },
  xuzhou: { lat: 34.2057, lng: 117.2841 },
  quanzhou: { lat: 24.8740, lng: 118.6759 },
